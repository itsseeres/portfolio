  ...
  return (
    <div className="w-full h-full relative">
        <motion.div initial={{opacity:0}} animate={{opacity:1, transition:{delay:2, duration:0.4, ease:"easeIn"}}}>
            ...
            absolute">
                <Image src="/assets/photo.png" priority quality={100} fill alt="Shirish Shrestha" className="object-contain"/>
            </motion.div>
            <motion.div>
                ...
                <motion.circle cx="253" cy="253" r="250" stroke="#06B6D4" strokeWidth="4"
